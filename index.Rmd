...
Let $P$ be a probability measure, the scoring rule $S(P,x)$ measures the accuracy of the ''forecast'' $P$ for the ''true'' value $x$.

A proper scoring rule is one such that 
